...
```bash
go get -u github.com/whiskerman/gmsm
```
...
- go package： `github.com/whiskerman/gmsm/sm2`
...
- g package：`github.com/whiskerman/gmsm/sm3`
...
- go package：`github.com/whiskerman/gmsm/sm4`

### 代码示例

```Go
    import  "crypto/cipher"
    import  "github.com/whiskerman/gmsm/sm4"
    import "fmt"
...
### 具体功能测试代码参考
```Go
github.com/whiskerman/gmsm/sm2/sm2_test.go  //sm2算法
github.com/whiskerman/gmsm/sm3/sm3_test.go  //sm3算法
github.com/whiskerman/gmsm/sm4/sm4_test.go  //sm4算法
github.com/whiskerman/gmsm/x509/x509_test.go //x509国密证书
github.com/whiskerman/gmsm/gmtls/gmcredentials/credentials_test.go  //国密tls
github.com/whiskerman/gmsm/gmtls/gmcredentials/websvr/websvr.go     //国密tls与非国密TLS自适应
```
